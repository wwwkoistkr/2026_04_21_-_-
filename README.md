# 🌅 Morning Stock AI — Briefing Center **v2.9.5** 🚀

## 🆕 v2.9.5 (2026-04-25) — 서술형 3태그 + 사용자 피드백 루프
- **보고서 형식 전환**: 10줄 이모지식 → 💰 핵심 현황 / 📈 전망과 파급 / 🎯 투자 시사점 **3개 문단 서술형** (자연스러운 흐름)
- **약점 피드백 루프**: 어드민에서 매일 0~100점 + 약점 축 입력 → 7일 평균 < 80점 + 샘플 ≥ 2개일 때 다음 Stage 2 프롬프트에 **자동 강화 지침 주입**
- **5개 약점 축**: 정확성 · 시의성 · 심층성 · 명료성 · 실행가능성
- **검증 강화**: MIN_ITEM_CHARS 450 → 600자, 글머리표 5개 이상이면 invalid (서술형 보장)
- **어드민 패널**: "내일 Stage 2 에 적용될 강화 지침" 실시간 표시 (rose/emerald 색상)
- **공개 API 신규**: `GET /api/public/feedback/signal?days=7` (Bearer BRIEFING_READ_TOKEN)
